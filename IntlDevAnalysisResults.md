...
The basic statistics, however, do not give the full picture of the evolution of engagement over time.  Some organizations may be doing better to build a following and grow engagement over time showing a more methodical strategy.  Figure 2 shows how posts and engagement have evolved over time for three of the organizations.  To view this it is necessary to Nevertheless some of these basic statistics are viewed with caution as a closer examination of World Bank and ADB page likes over time indicates that these likes may not be organic.  In contrast, comments and shares appear to suffer less from distortions.   
